...
values ('할명수','audtn@gmail.com','default.jpg', 'GIVER' );
insert into MEMBER(name, email, picture, role)
values ('정주나','wnsk@gmail.com','default.jpg', 'GIVER' );
insert into MEMBER(name, email, picture, role)
values ('비룡','qlfyd@gmail.com','default.jpg', 'TAKER' );
insert into MEMBER(name, email, picture, role)
values ('길', 'way@gmail.com', 'default.jpg', 'TAKER');
...
insert into shipping_address(address_detail,is_default, nickname, recipient, region_id, taker_id)
values('집', 'TRUE', '집','박명수', 1,3 );

insert into subscription(is_subscribed, price, recipient, shipping_message, shipping_status, product_id, shippingaddress_id, taker_id)
values ('TRUE', 1500, '박명수', '잘 갖다 주세요', 'PREPARING', 2, 1, 3);